    ...
    public class SoundgeniusDB : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Albuns>().HasData(
               new Albuns { ID = 1, Titulo = "MTV Unplugged", Genero = "Grunge", FicheiroImg = "dsfhshdfs", ArtistaFK = 1 },
               new Albuns { ID = 2, Titulo = "Bleach", Genero = "Grunge", FicheiroImg = "dsfhshdfs", ArtistaFK = 1 },
               new Albuns { ID = 3, Titulo = "Nevermind", Genero = "Grunge", FicheiroImg = "dsfhshdfs", ArtistaFK = 1 },
               new Albuns { ID = 4, Titulo = "The color and the shape", Genero = "Rock Alternativo ", FicheiroImg = "dsfhshdfs", ArtistaFK = 2 },
               new Albuns { ID = 5, Titulo = " In Your Honor", Genero = "Rock Alternativo ", FicheiroImg = "dsfhshdfs", ArtistaFK = 2 },
               new Albuns { ID = 6, Titulo = "Foo Fighters Echoes, Silence, Patience & Grace", Genero = "Rock Alternativo ", FicheiroImg = "dsfhshdfs", ArtistaFK = 2 },
               new Albuns { ID = 7, Titulo = "Testing", Genero = "Hip hop", FicheiroImg = "dsfhshdfs", ArtistaFK = 3 },
               new Albuns { ID = 8, Titulo = "Long. Live. ASAP", Genero = "Hip hop", FicheiroImg = "dsfhshdfs", ArtistaFK = 3 },
               new Albuns { ID = 9, Titulo = "goodbye & good riddance", Genero = "Hip hop ", FicheiroImg = "dsfhshdfs", ArtistaFK = 4 }
                );
